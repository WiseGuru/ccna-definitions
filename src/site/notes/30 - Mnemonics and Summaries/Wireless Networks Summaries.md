---
{"dg-publish":true,"permalink":"/30-mnemonics-and-summaries/wireless-networks-summaries/"}
---

#mnemonics

- [[20 - Definitions/CSMA-CA\|CSMA/CA]] (Carrier Sense Multi-Access with Collision Avoidance) is used to avoid collisions in wireless networks (like [[20 - Definitions/CSMA-CD\|CSMA/CD]] in wired networks)
- [[20 - Definitions/WPA Authentication Modes\|WPA Authentication Modes]]
	- *PSK* = **Personal**
	- *[[20 - Definitions/802.1X\|802.1X]]* = **Enterprise**
- WLC Trivia
	...
	- ![WLAN-WPA2-PSK-Config-1.png](/img/user/CCNA/Attachments/WLAN-WPA2-PSK-Config-1.png)
		- WLAN Tab>Edit WLAN
		- Security Subtab>[[15 - OSI Layers/Layer 2\|Layer 2]] Subtab
		- Choose *WPA+WPA2*
