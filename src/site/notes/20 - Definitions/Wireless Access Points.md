---
{"dg-publish":true,"permalink":"/20-definitions/wireless-access-points/","tags":["defs_ccna"]}
---

#### Wireless APs
- *Wireless Access Points* provide connectivity between wireless station and between wireless and wired networks
	- Wireless is half-duplex, kind of like a [[20 - Definitions/Hub\|Hub]]
...
- *Autonomous* (rarely but sometimes called *Local-MAC*)
	...
	- Typically connected to a [[20 - Definitions/Trunk\|Trunk]] port
- [[20 - Definitions/Lightweight APs\|Lightweight APs]] (also called *Split-MAC*)
	- Form a [[20 - Definitions/CAPWAP\|CAPWAP (Control and Provisioning of Wireless APs)]] tunnel with the [[20 - Definitions/WLC\|WLC]]
