---
{"dg-publish":true,"permalink":"/20-definitions/port-security/","tags":["defs_ccna"]}
---
...
- There are *three* violation modes
	...
	- **Shutdown**
		- Interface enters an [[20 - Definitions/Error Disabled\|Error Disabled]] state if more MAC addresses connect to an interface than are allowed
...
### Bringing an [[20 - Definitions/Error Disabled\|Error Disabled]] interface back up

After a violation, a port in **Shutdown violation mode** changes its status to *[[20 - Definitions/Error Disabled\|Error Disabled]]*, and is effectively **shut down**. To resume operation (sending and receiving traffic), we must bring it back up. Here's how:
