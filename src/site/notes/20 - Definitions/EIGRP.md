---
{"dg-publish":true,"permalink":"/20-definitions/eigrp/","tags":["defs_ccna"]}
---

#### EIGRP
- Enhanced Interior Gateway Routing Protocol
- #Cisco-Proprietary  routing protocol, called "advanced" [[20 - Definitions/Distance Vector Routing Protocols\|Distance Vector]] routing protocol
- Much better than [[20 - Definitions/RIP\|RIP]], but still a DV protocol
- EIGRP [[20 - Definitions/Router\|routers]] need to have the same Autonomous System (AS) number
	- `Config# router eigrp (AS number)`
		- `Config-router# network (Network address) (Wildcard mask)`
			- [[20 - Definitions/Wildcard mask\|Wildcard mask]]
...
- Terminology
	...
	- **Feasible Successor** an *guarantied loop-free* alternate route should the *Successor* go down that has a lower *Advertised Distance* than the *Successor's Feasible Distance*
		- The "Lower [[20 - Definitions/AD\|AD]] than Successor's FD" is known as the *Feasibility condition*

**NOTE**: I need a graph here to help illustrate all the EIGRP terms.

#### Unequal-Cost Load-balancing
- This is different from [[20 - Definitions/ECMP\|ECMP]]
	- By default, EIGRP uses [[20 - Definitions/ECMP\|ECMP]]
