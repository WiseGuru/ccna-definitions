---
{"dg-publish":true,"permalink":"/20-definitions/wep/","tags":["defs_ccna"]}
---

#### WEP
- *Wire-Equivalent Privacy (WEP)* encrypts traffic with [[20 - Definitions/RC4\|RC4]] Symmetric streaming encryption
...
- NOT SECURE
	- The *24-bit IV* is limited to 16.7 million values (2^24), which can easily be repeated on a busy network
		- Compare to [[20 - Definitions/AES\|AES]] minimum encryption key length of 128 bits, with 340 tredecillion values (2^128)
	- WEP implementations often reused *IVs*, which made it easier to predict and decrypt
- [[20 - Definitions/TKIP\|TKIP]] was implemented as a stop-gap for WEP
