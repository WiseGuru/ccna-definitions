---
{"dg-publish":true,"permalink":"/20-definitions/lan-topology/","tags":["defs_ccna"]}
---

#### LAN Topology
- The campus [[20 - Definitions/LAN\|LAN]] should be designed for scalability, performance, and security

### Three Layers in Traditional Design
1. 3-Tier network
2. Core layer
	1. Connect [[20 - Definitions/Router\|routers]] to Distribution layer switches
	2. Typically deployed in redundant pairs with downstream Distribution Layer [[20 - Definitions/Switch\|switches]] connected to both
...
3. Distribution layer
	...
	3. Most software policies, such as [[20 - Definitions/QoS\|QoS]], are enabled at this layer
4. Access Layer
...
1. Two-tiered network
	...
	2. Often used with [[20 - Definitions/Cisco ACI\|Cisco ACI]]
...
3. Leaf Switches connect to [[20 - Definitions/EPG\|EPG]]s (server groups) and [[20 - Definitions/Cisco APIC\|Cisco APIC]]s
...
2. This one device can provide:
	1. [[20 - Definitions/Router\|Router]]
	2. [[20 - Definitions/Switch\|Switch]]
	3. [[20 - Definitions/Firewall\|Firewall]]
	4. [[20 - Definitions/Wireless Access Points\|Wireless AP]]
