---
{"dg-publish":true,"permalink":"/20-definitions/http/","tags":["defs_ccna"]}
---
...
1. GET
	...
	2. Idempotent
	3. Includes sensitive information in the [[20 - Definitions/URI\|URI]], which can be logged
2. PUT
...
3. POST
	...
	3. Does not include form data in the request *URI*; instead, form data is encoded in a [[20 - Definitions/URL\|URL]], and calls a function on the server to process the information
4. HEAD
