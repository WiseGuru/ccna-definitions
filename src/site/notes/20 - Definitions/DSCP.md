---
{"dg-publish":true,"permalink":"/20-definitions/dscp/","tags":["defs_ccna"]}
---

#### DSCP
- *Differentiated Services Code Point* marking is the preferred method for [[20 - Definitions/QoS\|QoS]] classification and marking because the router can very quickly gather the information from a single byte in the IP header	
