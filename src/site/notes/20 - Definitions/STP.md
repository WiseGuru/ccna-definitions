---
{"dg-publish":true,"permalink":"/20-definitions/stp/","tags":["defs_ccna"]}
---
...
3.  [[20 - Definitions/IEEE\|IEEE]] Open Standards:
	...
	2.  **802.1w** [[20 - Definitions/Rapid STP\|Rapid STP]] (RSTP)
...
4.  Cisco Versions
	1.  Cisco released enhancements to the open standards
		1.  **Per VLAN Spanning Tree Plus (PVST+)**
			...
			3.  *PVST+* is the *default* on Cisco [[20 - Definitions/Switch\|Switches]]
	...
	2.  The Cisco versions do not support grouping multiple [[20 - Definitions/VLAN\|VLANs]] into the same instance
5. Misc
	1. *MAC Flapping* or *MAC Address Flapping* is when the same MAC address is active on two ports within a network.
		...
		2. This is almost always an indication of a loop in the network, but could also be an attacker on the network
			1. Attacks include CAM table poisoning, [[20 - Definitions/Layer 2 Attack Types\|MAC spoofing]], etc.

### STP Cost
(table from [PacketLife.net](https://packetlife.net/blog/2008/sep/5/spanning-tree-port-costs/))
![STP-Costs-1.png](/img/user/CCNA/Attachments/STP-Costs-1.png)
...
4.  Determine the Root Ports on the other [[20 - Definitions/Switch\|switches]]
...
#### Problem
![STP-Example-1.png](/img/user/CCNA/Attachments/STP-Example-1.png)
#### Solution
![STP-Example-Solution.png](/img/user/CCNA/Attachments/STP-Example-Solution.png)
