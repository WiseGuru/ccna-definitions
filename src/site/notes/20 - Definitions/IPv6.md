---
{"dg-publish":true,"permalink":"/20-definitions/i-pv6/","tags":["defs_ccna"]}
---
	...
	1. They are equivalent to IPv4's Private address ranges
		...
		3. ![IPv6-unique-local-1.png](/img/user/CCNA/Attachments/IPv6-unique-local-1.png) (source: [Unique local address - Wikipedia](https://en.wikipedia.org/wiki/Unique_local_address)) 
			...
			3. The *interface ID* is 64-bits long and unique to each device
				1. It can either be *stateful* (manually configured) or *stateless* with [[20 - Definitions/EUI-64\|EUI-64]] (automatically generated) with
3. *Link Local* - **FE80::/10**
	...
	2. It is required for [[20 - Definitions/NDP\|NDP]] and other 
...
| Ff02::2   | All IPv6 [[20 - Definitions/Router\|[[Router]]]]]]]]]]         |
| Ff02::5   | All OSPFv3 [[20 - Definitions/Router\|[[Router]]]]]]]]]]       |
| Ff02::a   | All EIGRP (IPv6) [[20 - Definitions/Router\|[[Router]]]]]]]]]] |
