---
{"dg-publish":true,"permalink":"/20-definitions/yaml/","tags":["defs_ccna"]}
---

#### YAML
1. Definition: *YAML Ain't Markup Language* (Originally, *Yet Another Markup Language*) is a human-readable format where whitespace is significant, and is used by [[20 - Definitions/Ansible\|Ansible]]
	1. Often used in [[20 - Definitions/Python\|Python]], Perl, and [[20 - Definitions/Ansible\|Ansible]]
