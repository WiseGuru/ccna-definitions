---
{"dg-publish":true,"permalink":"/20-definitions/dhcp-snooping/","tags":["defs_ccna"]}
---

#### DHCP Snooping
- *DHCP Snooping* inspects [[20 - Definitions/DHCP\|DHCP]] packets to prevent networking problems and attacks from rogue DHCP servers
- Compares addresses on the *DHCP Snooping binding* table
	...
	- [[20 - Definitions/DAI\|DAI]] also uses the *Snooping table* in its frame validation
...
- *Rate Limiting*
	...
	- [[20 - Definitions/Error Disabled\|Error Disabled]] interfaces can be *manually* or *automatically* returned to service
- DHCP *Option 82* (aka `information option`)
	...
	- By default, DHCP Snooping *tags all messages* from clients with *option 82*
		- However, [[15 - OSI Layers/Layer 2\|Layer 2]] Switches **drop** incoming DHCP packets with Option 82 on *untrusted ports* by default
