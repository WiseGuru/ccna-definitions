---
{"dg-publish":true,"permalink":"/20-definitions/ansible/","tags":["defs_ccna"]}
---

#### Ansible
##### KEY Summary
- Agentless
- Written in [[20 - Definitions/Python\|Python]]
- Uses a "Push" model
- Uses [[20 - Definitions/SSH\|SSH]] to connect to devices
- Uses [[20 - Definitions/YAML\|YAML]] for its necessary files
