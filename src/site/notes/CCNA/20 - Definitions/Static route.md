...
#### Static Routes
- *Static routes* are manually configuring [[CCNA/20 - Definitions/IP\|IP]] routes entered into a [[CCNA/20 - Definitions/21 - OSI Layers/Layer 3\|Layer 3]] device's [[CCNA/20 - Definitions/Routing Table\|Routing Table]].
