...
Definition: 
- Hubs are [[CCNA/20 - Definitions/OSI Layers/Layer 1\|Layer 1]] multi-port repeaters that forward signals to all active ports. Used for connecting multiple Ethernet devices together and making them act as a single network segment.
